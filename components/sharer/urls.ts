...
export let facebook: Sharer = function (input) {
	return `https://facebook.com/sharer.php?display=popup&u=${encodeURIComponent(input.url)}`
}
...
export let twitter: Sharer = function (input) {
	let result = `https://twitter.com/intent/tweet?url=${encodeURIComponent(input.url)}`
...
export let linkedin: Sharer = function (input) {
	return `https://www.linkedin.com/shareArticle?url=${encodeURIComponent(input.url)}`
}
...
export let reddit: Sharer = function (input) {
	let result = `http://www.reddit.com/submit?url=${encodeURIComponent(input.url)}`
...
export let pinterest: Sharer = function (input) {
	let result = `http://pinterest.com/pin/create/button/?url=${encodeURIComponent(input.url)}`
